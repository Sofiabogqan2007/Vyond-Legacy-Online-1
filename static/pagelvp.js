...
jQuery('#player-overlay-dismiss').click(function() {
    jQuery('#player-overlay').hide();
            ...
            <div class="video-actions">
                ...
                <button class="btn btn-link" data-remote="/ajax/getMovieShare/?video=${params.flashvars.movieId}" data-action="video-share"><span class="glyph-pro glyph-share-alt"></span> &nbsp; Share</button>
                <span class="divider">|</span>
            </div>
...
$('.video-actions').toggle($('.video-actions').find('.btn').length > 0);
            ...
            <div class="inside">
                <div class="video-social-share clearfix">
                    <div>
                        <div class="pull-left">
                            <div class="fb-like" data-href="https://vyondlegacyoffical.herokuapp.com/videos/?movieId=${params.flashvars.movieId}" data-send="true" data-layout="button_count" data-width="160" data-show-faces="false"></div>
                        </div>
                    </div>
                    <div style="width:70px">
                        <div class="pull-left">
                        <div class="g-plusone" data-size="medium" data-href="https://vyondlegacyoffical.herokuapp.com/videos/?movieId=${params.flashvars.movieId}"></div>
                        </div>
                    </div>
                    <div style="width:90px;">
                        <div class="pull-left">
                        <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://vyondlegacyoffical.herokuapp.com/videos/?movieId=${params.flashvars.movieId}" data-hashtags="goanimate">Tweet</a>
                        </div>
                    </div>
                    <div>
                        <div class="pull-left">
                        <a data-pin-config="beside" href="//pinterest.com/pin/create/button/?url=http%3A%2F%2Fvyondlegacyoffical.herokuapp.com%2Fvideos%2F%3FmovieId=${params.flashvars.movieId}&amp;media=%2Fmovie_thumbs%2F${params.flashvars.movieId}.png&amp;description=election" data-pin-do="buttonPin"><img src="//assets.pinterest.com/images/pidgets/pin_it_button.png"/></a>
                        </div>
                    </div>
                </div>
            </div>
